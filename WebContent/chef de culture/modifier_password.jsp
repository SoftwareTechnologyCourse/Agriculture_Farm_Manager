	...
	<form name=f action="../modifier_password"
		...
		<div>
			<table align="center" style="width: 500px; height: 106px">
				...
				<tr align="justify">
					<td bgcolor="Silver" rowspan="3" align="center">Update:</td>
				...
				<tr align="justify">
					...
					<td bgcolor="Gray"><input name="mdp1" type="password"
						...
						<span id="md" style="color: White; visibility: hidden;">Min
							6 caracteres</span> <span id="md1"
						style="color: White; visibility: hidden;">Insert a password</span>
					</td>
				</tr>
				<tr>
					<td bgcolor="Silver">Confirm your password:</td>
					<td bgcolor="Gray"><input name="mdp2" type="password"
						onblur="verifier_mdp2(this)" maxlength="20"
						style="color: Black; background-color: White; border-color: White; border-style: Inset; height: 20px; width: 150px;" />
						<span id="mp" style="color: White; visibility: hidden;">Wrong
							password</span> <span id="mp2" style="color: White; visibility: hidden;">Confirm
							your password</span></td>
				</tr>
				<tr>
