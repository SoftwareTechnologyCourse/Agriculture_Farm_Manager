...
<body>
	<form name=f action="../modifier_password"
		...
		<div>
			<table align="center" style="width: 500px; height: 106px">
				...
				<tr align="justify">
					<td bgcolor="Silver" rowspan="3" align="center">Modification:</td>
					<td bgcolor="Silver">Old password</td>
					<td bgcolor="Gray"><input name="old_passwd" type="password"
						maxlength="20" onblur="verifier_old_password(this)"
						style="color: Black; background-color: White; border-color: White; border-style: Inset; height: 20px; width: 150px;" />
						<span id="oldpasswd"
						style="color: White; visibility: hidden; position: absolute;">Old
							password is wrong</span> <br /></td>

					</td>
				</tr>
				<tr align="justify">
					<td bgcolor="Silver">New Password:</td>
					<td bgcolor="Gray"><input name="mdp1" type="password"
						onblur="verifier_mdp1(this)" maxlength="20"
						style="color: Black; background-color: White; border-color: White; border-style: Inset; height: 20px; width: 150px;" />
						<span id="md" style="color: White; visibility: hidden;">Min
							6 chars</span> <span id="md1" style="color: White; visibility: hidden;">insert
							a new password</span></td>
				</tr>
				<tr>
					<td bgcolor="Silver">Confirm your new password:</td>
					<td bgcolor="Gray"><input name="mdp2" type="password"
						onblur="verifier_mdp2(this)" maxlength="20"
						style="color: Black; background-color: White; border-color: White; border-style: Inset; height: 20px; width: 150px;" />
						<span id="mp" style="color: White; visibility: hidden;">password
							is wrong</span> <span id="mp2" style="color: White; visibility: hidden;">Confirm
							your new password</span></td>
				</tr>
				<tr>
