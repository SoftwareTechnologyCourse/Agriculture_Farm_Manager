...
<body>
	...
	<%
		...
		/********************************************************************/
		String requet1 = "insert into instocke values('" + code + "','" + quantite + "','" + magasin + "','" + agent
				+ "','" + obs + "','" + designation + "','" + etat + "','" + date + "')";
		String requet2 = "insert into outstocke values('" + code + "','" + quantite + "','" + magasin + "','"
				+ agent + "','" + obs + "','" + designation + "','" + tache + "','" + date + "','" + nom_produit
				+ "','" + nom_machine + "')";
		String requet4 = "insert into ennemie  values('" + code + "','" + nom_ennemie + "','" + pic_ennemie + "')";
		String requet3 = "insert into produit values('" + code + "','" + code_stock + "','" + nom_produit + "','"
				+ matiere + "','" + molecule + "','" + fournisseur + "')";
		String requet5 = "insert into machine values('" + code + "','" + code_stock + "','" + nom_machine + "','"
				+ obs + "')";
		String requet_3 = "insert into aune values('" + img_produit + "','" + code + "')";
		String requet_1 = "insert into stocke values('" + code + "','" + quantite + "','" + magasin + "','" + agent
				+ "','" + obs + "','" + designation + "')";
		String requet_2 = "delete from stocke  where CODESTOCKE= (select CODESTOCKE from produit where NOMCOMMERCIAL='"
				+ request.getParameter("nom_produit2") + "')";
		/********************************************************************/
		...
		try {
			if (valeur == 1) {
				...
				out.println("The data are Saved now");
			} else if (valeur == 2) {
