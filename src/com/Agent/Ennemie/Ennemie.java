...
public class Ennemie extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<title>Consultation of Products</title>");
		...
		out.println("</head>");
		out.println("<body>");
		request.getRequestDispatcher("Agent/header.jsp").include(request,response);
		out.println("<h1>this is the list of Ennemies </h1>");
		out.println("<form name=\"f\" action=\"Ennemie\">");
		out.println("<fieldset style=\"width: 500px\">");
		out.println("<legend>Chose a Name</legend>");
			...
			for(int i=0;i<resultat.size();++i)
			 {
				...
				out.println("<tr style=\"background-color:#DAFAC9;\"><th>Name of Ennemie</th><td>"+resultat_final.elementAt(1)+"</td></tr>");
				out.println("<tr><th>Pictures of the Ennemie</th><td><img src="+resultat_final.elementAt(0)+" alt=\"ok\" /></td></tr>");
			 }
	...
	request.getRequestDispatcher("Agent/footer.jsp").include(request,response);
	out.println("</html>");
}
}