	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<br>");
			 ...
			 for(int i=0;i<resultat.size();++i)
				{
		  			resultat_final=(Vector)resultat.elementAt(i);
					out.println("<tr><th>Code number of the plantation</th><td>"+resultat_final.elementAt(0)+"</td></tr>");
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>Area of the plantation</th><td>"+resultat_final.elementAt(1)+"</td></tr>");
					out.println("<tr><th>Date de Plentation</th><td>"+resultat_final.elementAt(2)+"</td></tr>");
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>Surgery</th><td>"+resultat_final.elementAt(4)+"</td></tr>");
					out.println("<tr><th>Nombre de Plente</th><td>"+resultat_final.elementAt(3)+"</td></tr>");
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>year of the surgery</th><td>"+resultat_final.elementAt(5)+"</td></tr>");
					out.println("<tr><th>Porte Greffe</th><td>"+resultat_final.elementAt(11)+"</td></tr>");
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>The coordinates of X1</th><td>"+resultat_final.elementAt(6)+"</td></tr>");
					out.println("<tr><th>coordonnée X2</th><td>"+resultat_final.elementAt(7)+"</td></tr>");
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>The coordinates of  Y1</th><td>"+resultat_final.elementAt(8)+"</td></tr>");
					out.println("<tr><th>Coordonnée Y2</th><td>"+resultat_final.elementAt(9)+"</td></tr>");
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>The description</th><td><textarea  rows=2 cols=20  disabled style=\"height:91px;width:330px;margin-bottom: 0px\">"+resultat_final.elementAt(10)+"</textarea></td></tr>");
				}
