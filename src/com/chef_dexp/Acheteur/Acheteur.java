 ...
 */
  public class Acheteur extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<title>List od suppliers</title>");
		...
		out.println("<br>");
			 ...
			 for(int i=0;i<resultat.size();++i)
				{
		  			resultat_final=(Vector)resultat.elementAt(i);
					out.println("<tr><th>Code of the supplier</th><td>"+resultat_final.elementAt(0)+"</td></tr>");
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>Supplier name</th><td>"+resultat_final.elementAt(1)+"</td></tr>");
					...
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>Phone number</th><td>"+resultat_final.elementAt(5)+"</td></tr>");
					out.println("<tr><th>phone number</th><td>"+resultat_final.elementAt(6)+"</td></tr>");
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>Account</th><td>"+resultat_final.elementAt(8)+"</td></tr>");
