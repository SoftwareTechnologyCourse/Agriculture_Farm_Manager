...
public class Fournisseur extends HttpServlet {
	...
	public Vector resultat;public Vector resultat_final;public Connect connexion=new Connect();
	/**
     * Default constructor. 
     */
    public Fournisseur() {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("</select>"); out.println("<div id='Fournisseur' >"); out.println("<table border=1 width=100% bordercolor=black>");out.println("<br>");
			 ...
			 for(int i=0;i<resultat.size();++i)
			 {
				 resultat_final=(Vector)resultat.elementAt(i);
					...
					out.println("<tr><th>Supplier's code</th><td>"+resultat_final.elementAt(0)+"</td></tr>");
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>Suppliers name</th><td>"+resultat_final.elementAt(1)+"</td></tr>");
	...
	out.println("</fieldset>");out.println("</form>");out.println("</body>");
